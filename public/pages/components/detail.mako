...
<!-- Required meta tags -->
 ...
 <nav class="navbar navbar-expand-lg" style="background-color: #EAEFF4;">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-link active" href="/adminpage/permittee">Permittees</a>
				<a class="nav-link" href="/adminpage/profiles">Profiles</a>
